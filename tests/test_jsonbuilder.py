...
def test_full():
    with open('tests/testdata/formatfull.json', 'r') as f:
        output = Tree(rapidjson.load(f), 'tests/testdata/testfull.csv', date='2020-02-02').build().toJson(indent=2)
    with open('tests/testdata/output_test_full.json', 'r') as f:
        expected_output = f.read()
    assert output == expected_output 

def test_full_csv_excel():
    with open('tests/testdata/formatfull.json', 'r') as f:
        output1 = Tree(rapidjson.load(f), 'tests/testdata/testfull.csv', date='2020-02-02').build().toJson(indent=2)
    with open('tests/testdata/formatfull.json', 'r') as f:
        output2 = Tree(rapidjson.load(f), 'tests/testdata/testfull.xlsx', date='2020-02-02').build().toJson(indent=2)
...
def test_full_csv_eval():
    with open('tests/testdata/formatfull.json', 'r') as f:
        output1 = Tree(rapidjson.load(f), 'tests/testdata/testfull.csv', date='2020-02-02').build().toJson(indent=2)
    with open('tests/testdata/formatfull.json', 'r') as f:
        output2 = Tree(rapidjson.load(f), 'tests/testdata/testfull.csv', date='2020-02-02', use_native_eval=True).build().toJson(indent=2)
    assert output1 == output2 

def test_full_excel_eval():
    with open('tests/testdata/formatfull.json', 'r') as f:
        output1 = Tree(rapidjson.load(f), 'tests/testdata/testfull.xlsx', date='2020-02-02').build().toJson(indent=2)
    with open('tests/testdata/formatfull.json', 'r') as f:
        output2 = Tree(rapidjson.load(f), 'tests/testdata/testfull.xlsx', date='2020-02-02', use_native_eval=True).build().toJson(indent=2)
    assert output1 == output2 
